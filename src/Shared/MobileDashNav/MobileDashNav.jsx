...
const MobileDashNav = () => {
    return (
            <div className="drawer lg:hidden block mx-10">
  <input id="my-drawer" type="checkbox" className="drawer-toggle" />
  <div className="drawer-content">
    <label htmlFor="my-drawer" className="btnn drawer-button"><svg
  ...
  <div className="drawer-side">
    ...
    <ul className="menu bg-[#D0FD3E]  text-black min-h-full w-60 p-4">
    <div className='  p-6  min-h-screen'>
           <div className="relative w-20">
				...
				<input type="search" name="Search" placeholder="Search menu..." className="w-40 py-2 pl-10 text-sm  focus:outline-none  bg-[#FFFFFF99] border rounded-lg" />
			</div>
